...
print("KNN klasifikaicja: ")
print("Tocnost train: " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_KNN)))) #tocnost klasifikacije
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost(KNN_train, n=5): " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_KNN))))
plt.tight_layout()
plt.show()


# zadatak 1.2 // Kako izgleda granica odluke kada je K =1 i kada je K = 100?
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost(KNN_train, n=1): " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_KNN))))
plt.tight_layout()
plt.show()
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost(KNN_train, n=100): " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_KNN))))
plt.tight_layout()
plt.show()

# zadatak 2

#odredjivanje optimalne vrijednosti K, k-strukom unakrsnom validacijom
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("Tocnost(SVM, C=0.1): " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_SVM))))
plt.tight_layout()
plt.show()
